export const serviceUrls = {
  plan: import.meta.env.VITE_PLAN_API_URL?.trim() || 'http://localhost:8082',
  session: import.meta.env.VITE_SESSION_API_URL?.trim() || import.meta.env.VITE_PLAN_API_URL?.trim() || 'http://localhost:8082',
